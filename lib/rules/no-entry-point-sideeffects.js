...
module.exports = {
  meta: {
    docs: {
      description: 'disallow SideEffects in the Entry Point',
      category: 'Fill me in',
      recommended: false
    },
  ...
  create: function(context) {
    ...
    return {
      'Program > :not(ImportDeclaration, ExportNamedDeclaration, ExportDefaultDeclaration, ExportAllDeclaration)': reportSideEffect
    }
  }
}
